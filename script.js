...
class App extends React.Component {constructor(...args) {super(...args);_defineProperty(this, "state",
  ...
  render() {
    ...
    return (
      ...
      React.createElement("h5", { className: "text-center" }, "Write your markdown here:"),
      React.createElement("textarea", { id: "editor", className: "form-control", value: text, onChange: this.handleChange.bind(this) })),


      React.createElement("div", { className: "col-6" },
      React.createElement("h5", { className: "text-center" }, "See the results here:"),
